...
{{- $svcPort := $svc.port.port -}}
{{- $svcProtocol := $svc.port.protocol -}}
{{- $prefix := "http" -}}
...
{{- end }}
{{- else if contains "NodePort" $svc.type }}
